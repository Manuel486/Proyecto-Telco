package com.example.apigateway.oauth;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/api/security/oauth/**","/api/catalogo/**","/recargar/**").permitAll()
		...
		.antMatchers("/api/servicios/**", "/api/consumidor/**", "/api/usuarios/**","/recarga/**").hasRole("ADMIN")
